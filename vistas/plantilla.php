...
<script>
<?php
// ✅ VARIABLES JAVASCRIPT SEGURAS CON VALIDACIÓN
$nombreUsuario = isset($_SESSION["nombre"]) ? addslashes(trim($_SESSION["nombre"])) : 'Usuario';
$nombreSucursal = defined('NOMBRE_SUCURSAL') ? addslashes(trim(NOMBRE_SUCURSAL)) : 'Sucursal';
$perfilUsuario = isset($_SESSION["perfil"]) ? addslashes(trim($_SESSION["perfil"])) : 'Invitado';

// Limpiar saltos de línea y caracteres problemáticos
...
?>
    ...
    if (!nombreUsuario || nombreUsuario === '') {
        console.warn('Nombre de usuario vacío, usando valor por defecto');
    }
