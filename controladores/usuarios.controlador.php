...
/*=============================================
INGRESO DE USUARIO (VERSIÓN FINAL Y SEGURA)
=============================================*/
static public function ctrIngresoUsuario()
{
    if (isset($_POST["ingUsuario"])) {
        if (preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingUsuario"])) {
            ...
            // Primero, verificamos que la base de datos SÍ encontró un usuario.
            // $respuesta será un array si lo encontró, o 'false' si no lo encontró.
            if ($respuesta && is_array($respuesta)) { 
                
                // Si se encontró, ahora sí comparamos la contraseña
